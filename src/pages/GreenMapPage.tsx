...
import { focusBafoussam, focusCameroon, focusWorld } from '../services/mapService';
...
export default function GreenMapPage() {
  ...
  return (
    <PageContainer title="Green Map" eyebrow="Live markers">
      <MapFilters onFocusWorld={() => setCenter(focusWorld())} onFocusCameroon={() => setCenter(focusCameroon())} onFocusBafoussam={() => setCenter(focusBafoussam())} />
